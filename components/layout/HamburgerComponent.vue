...
<template>
  <button @click="handleClick" :aria-expanded="props.menuOpen" class="relative group">
    <div class="relative flex overflow-hidden items-center justify-center rounded-full rounded-bl-none w-[50px] h-[50px] transform transition-all bg-primary duration-200 shadow-md">
